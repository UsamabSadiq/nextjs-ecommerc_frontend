...
const ProductCard = ({ height, width, hidden }) => {
    return (
        <>
            <Link href={'/product/1'}>
                <div className={`card1 hover:scale-105 overflow-hidden duration-300 border-2 w-fit cursor-pointer mx-auto ${height} ${width}`}>
                    <div className="card-content">
                        ...
                        <div className="text px-2 truncate my-2">
                            ...
                            <div className={`price flex justify-between items-center ${hidden}`}>
